...
const app = express();
const MONGODB_URL = "mongodb+srv://avaxiawebsite:avaxiawebsite@cluster0.bftcw.mongodb.net/?retryWrites=true&w=majority";
...
mongoose.connect(MONGODB_URL, {useNewUrlParser: false}).then(result => {
    app.listen(3000);
}).catch(err => {
    if (err) throw err;
});
